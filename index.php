...
if ( isset( $_POST['name'] ) ) {
    ...
    if ( $email ) {
        ...
        echo "<h2 class='errorh'>please fill up all the informations carefully</h2>";
    }
}
...
<head>
    ...
    <style>
    p.text-center.text-dark.rounded.bg-info.p-2 {
...
<body>
    ...
    <div class="container w-50  m-auto my-5">
        ...
        <?php if ( $inserts == true ) {
    echo ' <p class="text-center text-dark rounded bg-info p-2">thanks for submitting the form let\'s hope for safe & nice trip stay turned see you soon  </p>';
} ?>
